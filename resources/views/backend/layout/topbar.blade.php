         ...
         <nav class="navbar navbar-expand gap-3">
             ...
             <div class="user-box dropdown px-3">
                 ...
                 <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                     ...
                     <img @if (Auth::user()->profile_Photo) src="{{ asset(Auth::user()->profile_Photo) }}" @else src="{{ asset('uploads/no-image.png') }}" @endif class="user-img"
                         alt="user avatar">
                     <div class="user-info">
                         <p class="user-name mb-0">Hi,{{ $user->name }}</p>
