                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror" id="quantity" name="quantity"
                                    value="{{ old('quantity', $product->quantity) }}" placeholder="Product quantity">
                                    @error('quantity')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                @enderror" id="description" name="description" rows="3" placeholder="Description...">
